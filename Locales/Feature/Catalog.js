...
Roblox.LangDynamic["Feature.Catalog"] = {
    ...
    "Message.SuccessfulPurchaseOfItems": "You have successfully purchased {numberOfItems} items for {totalPriceView}.",
    ...
    "Message.Checkout.UnavailableItems": "One or more items can’t be purchased. Please remove them before continuing.",
    "Label.PBR": "Materials",
    "Label.PBRInfo":
    ...
    "Label.Checkout.WearAvatarReplaceAllItemsBody": "Wearing this avatar will replace all the items you are currently wearing.",
    "Title.Checkout.ClearAllItemsOnAvatarTitle": "Clear all items?",
    "Label.Checkout.ClearAllItemsOnAvatarBody": "This will remove all the unowned items you are wearing on your avatar.",
    ...
    "Label.Checkout.GoToCustomizeBody": "You can only wear or remove owned items in the Customize view.",
    ...
    "Label.Checkout.ItemReplacedOnAvatarBody": "You can only wear one item per category. A new item will always replace the one you're currently wearing.",
    ...
    "Label.TimedOptionsTooltipBody": "The timer starts after purchase, with options to extend or buy permanent",
    ...
    "Label.Makeup.MakeupMax6LayersPromptBody": "New makeup layers will always appear at the top, replacing the bottom layer until you free a slot.",
    "Label.Placement": "Placement",
    "Label.Top": "Top",
    "Label.Outerwear": "Outerwear",
    "Label.Bottom": "Bottom",
    "TrustedConnection.Label.Trusted": "Trusted",
    "Label.MakeupCartDescriptionText": "Any 6 eyes, lips and face, along with 1 eyelash and 1 eyebrow",
    "Label.Props": "Props",
