...
Roblox.LangDynamic["Feature.RobloxSubscription"] = {
    ...
    "Message.Error.Generic": "Something went wrong",
    "Action.Manage": "Manage",
    "Description.NextRenewal": "{date} for {price}",
    "Label.Status": "Status",
    "Label.Renews": "Renews",
    "Label.Joined": "Joined",
    "Label.Status.Active": "Active",
    "Label.Status.Expired": "Expired",
    "Label.YourDiscount": "Your discount",
    "Label.RobuxSaved": "Robux saved this year",
    "Label.Status.Cancelled": "Cancelled",
    "Description.Benefit.DiscountNextAlt": "{discountPercent} off unlocks in {dayCount, plural,\n  =1 {{dayCount} day}\n  other {{dayCount} days}\n}",
    "Label.Ends": "Ends",
    "Label.UseYourBenefits": "Use your benefits",
    "Action.Back": "Back",
    "Action.Home": "Home",
    ...
    "Action.PricePerMonth": "{price}/{periodType, select,\n Week {week}\n Month {month}\n Year {year}\n other {periodType} \n}",
    "Title.RobuxAmount": "{RobuxAmount} Robux",
    "Label.BlackbirdVTDiscountFirst": "{discountPercent}% off in-game items, avatars, and more",
    "Title.GetBlackbird": "Get Roblox Plus",
    "Body.GenericError": "We couldn't complete this right now. Please try again.",
    ...
    "Title.UnsupportedPlatform": "Roblox Plus unavailable here",
    "Body.UnsupportedPlatform": "This subscription isn't available to purchase on this device.",
    "Label.month": "month",
    "Label.months": "months",
    "Description.SavingWithPlus": "Saving {amountStart}{robuxAmount}{amountEnd} with Plus",
    ...
    "Description.Benefit.DiscountBaseSubtitle": "Get more from your Robux—starting now",
    ...
    "Disclosure.BlackbirdAgreementV2":
        'By clicking {underlineStart}{ctaText}{underlineEnd}, you agree to the <a href="{termsUrl}">Roblox Subscription Terms</a>. You will be automatically charged each month until you cancel.',
    "Description.ExclusiveBenefitsV2": "More fun for less Robux. Subscribe to Roblox Plus.",
    "Description.StrikethroughPriceAndFree": "{price} Free",
    "Label.FreeTrialPriceRow": "{boldStart}1 month free,{boldEnd} then $4.99/month",
    ...
    "Label.RobloxPlusPriceRowV2": "{boldStart}1 month free,{boldEnd} then {price}/{periodType}",
    ...
    "Description.Benefit.DiscountCurrent": "Your current discount is {discountPercent} off",
    "Description.Benefit.DiscountOffInDays": "{discountPercent} off in {dayCount, plural,\n =1 {{dayCount} day}\n other {{dayCount} days}\n}",
    ...
    "Description.Benefit.RobuxTransfersExpandedBody":
        "Instantly transfer Robux to other users without paying any fees on either side. To help keep transfers safe, there are transfer limits of up to 1000 Robux a month - which are subject to change. Additionally parent or caregiver approval is required every time users under 16 send or receive Robux.",
    ...
    "Description.FreeTrialExpired": "Subscribe to keep everything you love about Roblox Plus and more—for $4.99/month.",
    "Description.FreeTrialConfirmation": "Congratulations! You’ve unlocked Plus benefits, free for 1 week.",
    ...
    "Description.BannerBodyUnboxed": "Head to your inventory to see what's inside.",
    "Description.BannerTitleUnboxed": "Your Plus gift is now open!",
    ...
    "Description.ReferralShare": "Invite someone to Plus and you both get {amount} Robux when they join.",
    "Description.ReferralReferrerReward": "When anyone joins Plus with your link.",
    "Label.ReferralYouGet": "You get",
    "Description.ReferralRecipientReward": "Offer valid for new Plus subscribers only.",
    "Label.ReferralTheyGet": "Your referrals get",
    "Description.ReferralShareLink": "Referral link",
    ...
    "Action.ReferralJoinPlus": "Join Roblox Plus",
    "Description.ReferralIneligible": "This referral reward is not available on your account. You can still join Roblox Plus.",
    "Description.ReferralInvalid": "This referral link is no longer valid. You can still join Roblox Plus without the referral reward.",
    "Description.ReferralRecipientInvitedBy": "{displayName} invited you to join Plus. You'll both get {amount} Robux when you join.",
