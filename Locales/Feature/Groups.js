...
Roblox.LangDynamic["Feature.Groups"] = {
    ...
    "Error.CreateKeywordModerated": "One or more of your words may not show up in the list as they are already blocked by Roblox",
    ...
    "Description.VerificationMedium": "Users must be ID verified, or phone and email verified before joining",
    ...
    "Modal.ContentTextHigh": "Verify your account to join this community.\n\n1. Go to Account Info > Verify My Age\n2. Complete the verification process",
    ...
    "Description.GroupWallDeprecatedNoForums": "Forums are now available! Ask your community owner for details",
    ...
    "Description.AccountTenureRequirementExplanation": "Only accounts created more than the selected number of days ago can join.",
    ...
    "Description.AnnouncementsOnlyOneLinkedServerAlert": "A Guilded server can now only be connected to one Roblox community.",
    "Label.Search": "Search",
    ...
    "Description.ForumCategoryPermissions": "Category permissions will overrule Community permissions within the given Category",
    ...
    "Error.RetryAfterSeconds": "Slow Mode enabled. Please wait {seconds} seconds before sending again.",
    ...
    "Description.UpdateGroupCoverPhoto": "Cover photo must be one of the available dimensions: {dimensions}",
    ...
    "Description.CategoryPermissionsUpsell": "You can now set permissions specific to a Forum category",
    ...
    "Error.AnnouncementModerated": "Your announcement does not meet Roblox moderation standards. Please revise and try posting again.",
    ...
    "Message.GracefulDegradationCommunities": "Due to high traffic, we're showing a simplified community space. Check back later for the full view.",
    ...
    "Description.GroupShoutDeprecated": "Announcements are the new way to share updates with your community. Try posting one now!",
    ...
    "Message.MultiRolesUpsell": "Layer permissions and create custom vanity roles to organize your community exactly how you want",
    "Heading.CheckAgeInfo": "Let's check your age",
    "Description.CheckAgeInfo": "Complete this quick step to unlock posting, commenting, and replying in forums",
    "Heading.AgeCheck": "You need to complete an age check before you can post",
    "Description.AgeCheck": "It just takes a quick second. Then you can jump straight into the conversation",
    ...
    "Message.DeleteRoleAutoAssignWarning": "New members will be assigned the base member role only. Are you sure you want to delete {role}?",
    ...
    "Description.RoleRestrictedCategoryRolesList": "Only the following roles have access to this category",
    "Description.RoleRestrictedCategoryNoRoles": "No roles have been added to this category yet",
    "Description.UnrestrictDialog": "Unrestricting this category will immediately make all topics, comments, and replies in the category publicly visible.",
    "Message.RankReservedOnlyForGuest": "Ranks must be between {minRankPlusOne} and {maxRank}. {minRank} is reserved for guests.",
    ...
    "Label.SupportTicketDetailsPlaceholder": "Include anything relevant about the issue, like the game version and how to reproduce the steps.",
    ...
    "Description.BugReportingForumCategoriesUpsell": "Select the roles in each category that can attach bug reports below",
    ...
    "Description.PreventSimilarContent": "We'll automatically hide similar content in this community from now on.",
    ...
    "Description.CommunityCompletionAnnouncementCard": "Announcements notify members even when offline.",
    ...
    "Description.ForumsNotAvailable": "The following requirements must be met before activating forums. Continue to learn more.",
    ...
    "Description.CommunityTierSubheading": "Complete the requirements below and expand your community's capabilities.",
    ...
    "Message.SupportTicketLimitReached": "Cannot create a support ticket: the open support-ticket limit for this experience has been reached.",
    "Message.SupportTicketIneligible": "You cannot create a support ticket for this experience right now.",
