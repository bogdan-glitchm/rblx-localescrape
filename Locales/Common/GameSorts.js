...
Roblox.LangDynamic["Common.GameSorts"] = {
    ...
    "Label.SponsoredAdsDisclosureStatic":
        "Sponsored Experiences are paid for by Creators. For EU users, they may be shown to you based on general information about your device type, location, and demographics. Outside of the EU, ads may also be shown based on additional information.",
    "Label.CCUBasedSort": "Hot Right Now",
    "Label.CCUBasedSortTooltip": "Top experiences sorted by the number of concurrent users.",
    "Label.TopPlayedNow": "Top Played Now",
    "Label.TopPlayingNow": "Top Playing Now",
    "Label.ContentLoadFailed": "Content failed to load",
    "Label.CohortCCUSubtitle": "Showing player count based on selected filters",
    "Label.CCUBasedCohortSortTooltip":
