...
Roblox.LangDynamic["Purchasing.RedeemGameCard"] = {
    "Heading.RedeemRobloxCards": "Redeem Roblox cards",
    "Heading.HowToUse": "How to Use",
    "Description.RetailerLink":
        "Buy a Roblox gift card at one of the {retailerLinkStart}participating retailers{retailerLinkEnd} or receive a Roblox gift card from someone. ",
    ...
    "Description.LegalAgreement":
        "By redeeming your code, you represent that you, and your parent or legal guardian if you are under age 18, agree to our {termsOfUseLinkStart}Terms of Use{termsOfUseLinkEnd} including the arbitration clause and to our {privacyPolicyLinkStart}Privacy Policy{privacyPolicyLinkEnd}.",
    ...
    "Label.ConvertCreditSuccess": "Convert remaining credit to Robux",
    ...
    "Message.Step3ConvertRobux":
        "Your purchase was successful, but you still have some credit left. Do you want to convert\n{remainingCreditBalance} to Robux? {lineBreaker}{robuxConversionAmount} will be added to your balance.",
    ...
    "Response.RedeemGiftCardCurrencyCodeNotMatchV2":
        "Gift card currency must match your account location. You can review your account location in Settings. For any further issues, please contact {robloxSupportLinkStart}Roblox.com/support{robloxSupportLinkEnd}.",
    ...
    "Description.ConvertRobloxCreditGetUpTo20PercentMoreRobux": "Get up to 20% more when you convert your Roblox Credit to Robux.",
    "Heading.ConvertRobloxCreditGetUpTo20PercentMoreRobux": "Get up to 20% more when converting Roblox Credit to Robux",
    "Label.OfferAvailableOnDesktopWeb": "Offer available on desktop and web",
    "Description.RobuxTreasureChestImageAlt": "Robux treasure chest",
    "Description.ConvertRobloxCreditGet20PercentMoreRobux": "Get 20% more when you convert your Roblox Credit to Robux.",
    "Heading.ConvertRobloxCreditGet20PercentMoreRobux": "Get 20% more when converting Roblox Credit to Robux",
    "Action.RedeemGiftCardOrItemOrPromoCodeDisabled": "Roblox Gift Cards are not redeemable on the mobile app and must be redeemed on the web",
    "Action.RedeemACode": "Redeem a Code",
    ...
    "Message.25PercentMoreRobuxConvert": "This amount includes a bonus of up to 25% for all Robux purchased on web.",
    "Description.LegalAgreementOnCreditBalanceCheckoutWithTax":
    ...
    "Header.OrderSummary": "Order summary",
    "Label.CalculatingTax": "Calculating tax",
    "Description.CalculateTaxError": "We couldn't calculate tax. Please try again.",
    "Label.ConvertibleCredit": "Convertible credit",
    "Message.RobuxPurchased": "Robux package",
    "Message.IncludesUpToTwentyFivePercentMoreRobux": "Includes up to 25% more Robux",
    "Message.EnjoyUpToTwentyFivePercentMoreRobux": "Enjoy up to {boldStart}25% more Robux{boldEnd} with your gift card credit",
    "Heading.ConvertCreditToRobux": "Convert credit to Robux",
    "Label.RemainingBalance": "Remaining balance",
    "Label.LearnAboutRobloxSafety": "Learn About Roblox Safety, Moderation, and Parental Controls",
    "Label.ScanGiftCard.LoadingCamera": "Loading camera",
    "Label.ScanGiftCard.ValidatingPINCode": "Validating PIN code",
    "Label.ScanGiftCard.CaptureTheBackOfYourCard": "Capture the back of your card",
    "Label.ScanGiftCard.PlacePINCodeInsideHere": "Align your PIN inside this frame",
    ...
    "Description.ScanGiftCard.SorryWeCouldntAccessCamera": "Sorry, we couldn't access your camera. Please check your camera permissions and try again.",
    "Description.ScanGiftCard.SorryWeCouldntReadCard": "Sorry, we couldn't read your card. Please try again or enter your code manually.",
    ...
    "Action.ScanGiftCard.IveUpdatedMyCameraSettings": "I've updated my camera settings",
