...
Roblox.LangDynamic["Purchasing.PurchaseDialog"] = {
    ...
    "Heading.ErrorOccured": "Error Occurred",
    ...
    "Message.InsufficientRobuxExceedLargestPackage":
        "{divTagStart}You need an additional {robuxNeeded}. Please purchase more Robux Packages, then come back to the shop.{divTagEnd}",
    ...
    "Heading.PartialSuccessInsufficientFundsFailure":
        "{itemCountSuccess} item(s) has/have been purchased, {itemCountFailure} item(s) failed due to insufficient funds",
    ...
    "Heading.InExperienceOnlyFailure": "Purchase failed, these item(s) can only be purchased in-experience.",
    "Heading.PartialSuccessInExperienceOnlyFailure":
        "{itemCountSuccess} item(s) has/have been purchased, {itemCountFailure} item(s) failed as these items can only be purchased in-experience.",
    "Action.ContinueToPayment": "Continue To Payment",
    "Heading.LeavingRoblox": "Leaving Roblox",
    "Description.RedirectToPartnerWebsite":
        "This purchase must be completed on our partner’s website. You will be returned to Roblox after the purchase is completed.{linebreak}Proceed to partner website for payment?",
    "Message.PendingDeveloperProductLimitReached": "Join the experience to redeem your previous purchases before buying more products.",
    "Heading.PendingDeveloperProductLimitReached": "Can't Purchase",
    "Message.PromptBuySimplified": 'Would you like to buy "{assetName}" for {robux}?',
    "Message.AdditionalRobux": "You need additional Robux. Please purchase more, then come back to the shop.",
    "Message.InsufficientRobuxNew":
        "{divTagStart}You need an additional {robuxNeeded}. {sentenceSplit}Would you like to buy a {originalRobuxPackageAmount}{robuxPackageAmount} package?{divTagEnd}{lineBreak}{divTagFooterStart}Your payment method will be charged. Roblox {aTagStart}Terms of Use{aTagEnd} apply.{divTagFooterEnd}",
    "Heading.InsufficientRobuxNew": "You need more Robux",
    "Text.BonusBannerV1": "🎉 Bonus {robux} included for buying on your computer!",
    "Text.BonusBannerV2": "You are getting {robux} more for buying on your computer",
    "Heading.EconomicRestrictionsError": "Cannot complete this action",
    "Title.BuyExperience": "Buy experience",
    "Title.BuyItemV2": "Buy item",
    "Heading.BuyItemsV2": "Buy items",
    "Title.BuyRobuxAndItem": "Buy Robux and item",
    "Message.TermsOfUse": "Your payment method will be charged. Roblox {aTagStart}Terms of Use{aTagEnd} apply.",
    "Label.TimedOptionDaysAbbreviation": "{days}d",
    "Label.TimedOptionDaysTimerStartsWhenYouBuy": "{days} days (Timer starts when you buy)",
    "Message.InsufficientRobuxNewV2":
        "{divTagStart}You need an additional {robuxNeeded}. {sentenceSplit}Would you like to buy a {originalRobuxPackageAmount}{robuxPackageAmount} package for {price}?{divTagEnd}{lineBreak}{divTagFooterStart}Your payment method will be charged. Roblox {aTagStart}Terms of Use{aTagEnd} apply.{divTagFooterEnd}",
    "Description.SubscribeTermsAgreement":
        'By clicking "Subscribe", you agree to the {linkStart}Terms of Use{linkEnd}. You will be automatically charged each month and can cancel at any time.',
    "Message.UnifiedPurchaseCompletion": "You have successfully bought {boldStart}{assetName}{boldEnd}",
