...
Roblox.LangDynamic["Authentication.AccountSwitch"] = {
    ...
    "Action.AddAnAccount": "Add an account",
    "Action.SignInToExistingAccount": "Sign in to existing account",
    "Header.SwitchAccountSentenceCase": "Switch accounts",
    "Description.AccountLimit.2": "You’ve reached your account limit. To add a new one, remove an account first.",
    "Action.RemoveAllAccounts": "Remove all accounts?",
    "Description.RemoveAllAccounts": "Once you sign out, all accounts will be removed from this device.",
    "Action.Continue": "Continue",
    "Header.SignOutOtherAccounts": "Sign out of other accounts?",
    "Description.ContinueSignOutOthers": "Continuing as {username} will sign you out of your other accounts.",
    ...
    "Description.ContinuingAsAccount": "Continuing as {username} will add it to the account switcher. You can switch anytime.",
    "Description.AlwaysContinueAs": "Always continue with the selected account and add it to the account switcher.",
    "Description.ContinuingWith": "Continuing with {username} will sign you out of all other accounts.",
    "Description.HaveUpToAccountLimit": "You can have up to {limit} accounts. Remove one to make space for the selected account.",
    "Header.SignOutToContinue": "Sign out to continue",
    "Description.SignOutToCreateAccount": "You can’t create a new account while signed into this account. Sign out to continue creating your account.",
    "Description.SignOutToLogIn": "You can’t log into another account while signed into this account. Sign out to continue logging in.",
    "Action.SignOut": "Sign out",
    "Action.BackToHome": "Back to home",
    "Description.ContinueSignOutOthersGeneric": "Continuing will sign you out of your other accounts.",
};
