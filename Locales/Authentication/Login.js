...
Roblox.LangDynamic["Authentication.Login"] = {
    "Action.Login": "Login",
    "Label.Login": "Log in",
    ...
    "WeChat.AntiAddictionText":
        "Boycott bad experiences, refuse pirated experiences. Be aware of self-defense and being deceived. Visiting experiences is good for your brain, but too much experience visit can harm your health. Manage your time well and enjoy a healthy lifestyle.",
    "WeChat.RealNameNotVerified":
        "Your WeChat is not real-name verified. Please use a real-name verified WeChat account and try again. Please visit https://jiazhang.qq.com/zk/home.html",
    "Response.SomethingWentWrong": "Something went wrong. Please try again later.",
    "Label.WeChatAntiAddictionText":
        "Boycott bad experiences, refuse pirated experiences. Be aware of self-defense and being deceived. Visiting experiences is good for your brain, but too much experience visit can harm your health. Manage your time well and enjoy a healthy lifestyle.",
    "Response.WeChatRealNameNotVerified":
        "Your WeChat is not real-name verified. Please use a real-name verified WeChat account and try again. Please visit https://jiazhang.qq.com/zk/home.html",
    "Response.WeChatNotRealNameVerified":
        "Your WeChat is not real-name verified. Please use a real-name verified WeChat account and try again. Please visit {url}",
    ...
    "Action.QuickSignIn": "Quick sign-in",
    "Action.Next": "Next",
    "Label.TapToEnter": "Tap to enter",
    "Label.OrTryAnotherWay": "Or, try another way",
    ...
    "Description.U13.GetOneTimeCodeHelp": "Enter the email on your account to receive a one-time code.",
    "Action.LogInPasskey": "Log In With Passkey",
    "Heading.SecurityNotification": "Security Notification",
    "Description.RecoverYourAccount":
    ...
    "Action.RecoverYourAccount": "Recover your account",
    "Error.PasskeyOnlyAccount": "Your account only has a passkey set up for sign-in. Try signing in with your passkey or recover your account.",
    "Label.EmailPhone": "Email/Phone",
    ...
    "Label.DontHaveAnAccountCreateOne": "Don't have an account? {startTag}Create one{endTag}",
